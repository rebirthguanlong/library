...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'书籍管理',items:[
        		{id:'12',text:'书籍查询',href:'<%=request.getContextPath()%>/user/show'},
        		{id:'3',text:'书籍借阅',href:'<%=request.getContextPath()%>/user/back'},
        		{id:'4',text:'书籍归还',href:'<%=request.getContextPath()%>/user/showBackBook'},
        		{id:'5',text:'书籍预定',href:'<%=request.getContextPath()%>/user/showReserveBook'}
       	]}]}];
